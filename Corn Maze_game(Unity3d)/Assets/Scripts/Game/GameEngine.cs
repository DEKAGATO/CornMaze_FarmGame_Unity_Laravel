...
public class GameEngine : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (isGameStart)
        {
            ...
            if (Input.location.lastData.latitude < 45.25189f + 0.00015f && latitude > 45.25189f - 0.00015f && Input.location.lastData.longitude > -74.30469f - 0.00015f && Input.location.lastData.longitude < -74.30469f + 0.00015f && isReachedCorn)
            {
                isReachedCorn = false;
                isWithchCreate = true;
                isWolfCreate = true;
                ...
                if (Input.location.lastData.latitude < 45.25189f + 0.00007f && latitude > 45.25189f - 0.00007f && Input.location.lastData.longitude > -74.30469f - 0.00007f && Input.location.lastData.longitude < -74.30469f + 0.00007f && isInFrontGate)
            {
                isInFrontGate = false;
            ...
            if (Input.location.lastData.latitude < 45.25189f + 0.00005f && Input.location.lastData.latitude > 45.25189f - 0.00005f && Input.location.lastData.longitude > -74.30469f - 0.00005f && Input.location.lastData.longitude < -74.30469f + 0.00005f)
            {
        ...
        if (Input.location.lastData.latitude < 45.25280343f + 0.0001f && Input.location.lastData.latitude > 45.25280343f - 0.0001f && Input.location.lastData.longitude > -74.30343591f - 0.0001f && Input.location.lastData.longitude < -74.30343591f + 0.0001f && isWolfCreate)
        {
            isOnlyOneTime = false;
            isWolfCreate = false;
        ...
        if (Input.location.lastData.latitude < 45.25228283f + 0.00010f && Input.location.lastData.latitude > 45.25228283f - 0.00010f && Input.location.lastData.longitude > -74.30269732f - 0.00010f && Input.location.lastData.longitude < -74.30269732f + 0.00010f && isCloudCreate)
        {
            isCloudCreate = false;
            isOnlyOneTime = false;
        ...
        if (Input.location.lastData.latitude < 45.25152951f + 0.00010f && Input.location.lastData.latitude > 45.25152951f - 0.00010f && Input.location.lastData.longitude > -74.30396894f - 0.00010f && Input.location.lastData.longitude < -74.30396894f + 0.00010f && isWithchCreate)
        {
            isOnlyOneTime = false;
        ...
        if (isPassedArc)
        {
            if (Input.location.lastData.latitude < 45.25231740f + 0.00015f && Input.location.lastData.latitude > 45.25231740f - 0.0001f && Input.location.lastData.longitude > -74.30456802f - 0.0001f && Input.location.lastData.longitude < -74.30456802f + 0.0001f)
            {
                isPassedArc = false;
        ...
        if (isFirstGamePlay)
        {
            ...
            {
                if (Input.location.lastData.latitude < 45.25258225f + 0.0001f && Input.location.lastData.latitude > 45.25258225f - 0.0001f && Input.location.lastData.longitude > -74.30386916f - 0.0001f && Input.location.lastData.longitude < -74.30386916f + 0.0001f)
                {
        ...
        {
            if (Input.location.lastData.latitude < 45.25227319f + 0.00015f && Input.location.lastData.latitude > 45.25227319f - 0.00015f && Input.location.lastData.longitude > -74.30268418f - 0.00015f && Input.location.lastData.longitude < -74.30268418f + 0.00015f && isOnlyOneTime)
            {
                isOnlyOneTime = false;
        ...
        {
            if (Input.location.lastData.latitude < 45.25210850f + 0.0001f && Input.location.lastData.latitude > 45.25210850f - 0.0001f && Input.location.lastData.longitude > -74.30359346f - 0.0001f && Input.location.lastData.longitude < -74.30359346f + 0.0001f)
            {
        ...
        {
            if (Input.location.lastData.latitude < 45.25179729f + 0.00010f && Input.location.lastData.latitude > 45.25179729f - 0.00010f && Input.location.lastData.longitude > -74.30376021f - 0.00010f && Input.location.lastData.longitude < -74.30376021f + 0.00010f && isOnlyOneTime)
            {
                isOnlyOneTime = false;
        ...
        {
            if (Input.location.lastData.latitude < 45.25149666f + 0.00010f && Input.location.lastData.latitude > 45.25149666f - 0.00010f && Input.location.lastData.longitude > -74.30374197f - 0.00010f && Input.location.lastData.longitude < -74.30374197f + 0.00010f)
            {
        ...
        if (isAllFound)
        {
            if (Input.location.lastData.latitude < 45.25146902f + 0.00007f && Input.location.lastData.latitude > 45.25146902f - 0.00007f && Input.location.lastData.longitude > -74.30411845f - 0.00007f && Input.location.lastData.longitude < -74.30411845f + 0.00007f && !isInEndGate)
            {
            ...
            if (isExitDialog)
            {
                if (Input.location.lastData.latitude < 45.25146902f + 0.00005f && Input.location.lastData.latitude > 45.25146902f - 0.00005f && Input.location.lastData.longitude > -74.30411845f - 0.00005f && Input.location.lastData.longitude < -74.30411845f + 0.00005f)
                {
                    snapChat[0].SetActive(true);
                    isType = true;
